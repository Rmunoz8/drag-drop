window.onload = function(){
  ...
  document.addEventListener("dragenter", function( event ) {
      ...
      if(event.target.id == "hueco1" && dragged.id == "figura1"){
            document.getElementById("corrector").style.backgroundColor = "green";
      }
       if(event.target.id == "hueco2" && dragged.id == "figura2"){
        event.target.style.border = '3px dotted #555';
      }
  ...
  document.addEventListener("dragleave", function( event ) {
      ...
      if(event.target.id == "hueco1" || event.target.id == "hueco2" || event.target.id == "hueco3" || event.target.id == "hueco4"){
          document.getElementById("corrector").style.backgroundColor = "#F7B577";
      }else{
          document.getElementById("corrector").style.backgroundColor = "red";
      }
